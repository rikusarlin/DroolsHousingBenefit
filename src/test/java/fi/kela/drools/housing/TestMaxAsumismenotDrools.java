...
public class TestMaxAsumismenotDrools {
	
    static Logger logger = LoggerFactory.getLogger(TestMaxAsumismenotDrools.class.getName());
    ...
    private void insertHakemusObjectsIntoSession(KieSession session, YlatEtuusAsia etuusAsia) {
