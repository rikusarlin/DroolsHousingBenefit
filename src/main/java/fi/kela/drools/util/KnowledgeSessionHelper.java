...
public class KnowledgeSessionHelper {
    ...
    private static Logger logger = LoggerFactory.getLogger(KnowledgeSessionHelper.class.getName());
	  ...
	  public static KieSession getStatefulKnowledgeSessionForJBPM(
	        ...
	        session.addEventListener(new ProcessEventListener() {
	              ...
	              public void beforeProcessStarted(ProcessStartedEvent arg0) {
	                  logger.debug("Process Name "+arg0.getProcessInstance().getProcessName()+" has been started");
	              }
